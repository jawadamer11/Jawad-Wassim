...
public class viewing_schedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx1 = findViewById(R.id.Mon);
        tx2 = findViewById(R.id.Tue);
        tx3 = findViewById(R.id.Wed);
        tx4 = findViewById(R.id.Thu);
        tx5 = findViewById(R.id.Fri);
        tx6 = findViewById(R.id.Sat);
